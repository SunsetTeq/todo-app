...
func (s *TodoItemService) Create(userId, listId int, item firstRestApiProject.TodoItem) (int, error) {
	_, err := s.listRepo.GetById(userId, listId)
	if err != nil {
		// если такого списка нет или он не принадлежит пользователю
		return 0, err
	}
...
func (s *TodoItemService) Update(userId, itemId int, input firstRestApiProject.UpdateItemInput) error {
